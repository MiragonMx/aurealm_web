...
A sample character creation for your own hero can be found [here]({{< ref "/system/character_creation/index.md" >}}), the combat system of the rulebook is explained in detail [here]({{< ref "/system/combat_system/index.md" >}}).
